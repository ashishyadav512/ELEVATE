...
export class MemStorage implements IStorage {
  ...
  private initializeData() {
    ...
    this.createProduct({
      ...
      price: 299,
      imageUrls: ["https://images.unsplash.com/photo-1543508282-6319a3e2621f"],
      isFeatured: true,
      isNew: true,
    ...
    this.createProduct({
      ...
      price: 245,
      imageUrls: ["https://images.unsplash.com/photo-1556906781-9a412961c28c"],
      isFeatured: true,
      isNew: true,
    ...
    this.createProduct({
      ...
      price: 210,
      salePrice: 280,
      imageUrls: ["https://images.unsplash.com/photo-1600269452121-4f2416e55c28"],
      isFeatured: true,
    ...
    this.createProduct({
      ...
      price: 240,
      imageUrls: ["https://images.unsplash.com/photo-1608231387042-66d1773070a5"],
      categoryId: runningCategory.id,
    ...
    this.createProduct({
      ...
      price: 180,
      imageUrls: ["https://images.unsplash.com/photo-1491553895911-0055eca6402d"],
      categoryId: lifestyleCategory.id,
